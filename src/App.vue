...
export default class App extends Vue {
  ...
  created(): void {
    ...
    this.mainDs = new DataSource([
      { id: 'timeseries1', title: 'timeseries1', type: 'hlocv', data: [], locked: false, visible: true },
      { id: 'hl1', title: 'hline1', type: 'HLine', data: { def: -0.5, style: { lineWidth: 1, fill: 0, color: '#AA0000' } }, locked: true, visible: true },
      { id: 'hl2', title: 'hline2', type: 'HLine', data: { def: -0.25, style: { lineWidth: 2, fill: 1, color: '#00AA00' } }, locked: false, visible: true },
      { id: 'hl3', title: 'hline3', type: 'HLine', data: { def: 0, style: { lineWidth: 3, fill: 2, color: '#0000BB' } }, locked: false, visible: true },
      { id: 'hl4', title: 'hline4', type: 'HLine', data: { def: 0.25, style: { lineWidth: 4, fill: 3, color: '#AA00BB' } }, locked: false, visible: true },
      { id: 'hl5', title: 'hline5', type: 'HLine', data: { def: 0.5, style: { lineWidth: 5, fill: 4, color: '#AA00BB' } }, locked: false, visible: true },
      { id: 'vl1', title: 'vline1', type: 'VLine', data: { def: 0, style: { lineWidth: 3, fill: 2, color: '#AABBCC' } }, locked: false, visible: true },
    ]);
  }
  ...
  mounted(): void {
    ...
    // const secondPane = chartApi.createPane(new DataSource([{ id: 'line1', type: 'line', data: [], title: 'line11', locked: true, visible: true }])); // use autogenerated id
    // const thirdPane = chartApi.createPane(new DataSource([{ id: 'line1', type: 'line', data: [], title: 'line21', locked: true, visible: true }]));
